...
public class CovidCertificateRevocationController {
    ...
    public ResponseEntity<HttpStatus> create(@RequestBody RevocationDto revocationDto) throws InvalidBearerTokenException {
        ...
        log.info("kpi: {} {} {}", kv(KPI_TIMESTAMP_KEY, kpiTimestamp.format(LOG_FORMAT)), kv(KPI_REVOKE_CERTIFICATE_TYPE, KPI_SYSTEM_API), kv(KPI_UUID_KEY, userExtId));
        kpiDataService.saveKpiData(kpiTimestamp, KPI_REVOKE_CERTIFICATE_TYPE, userExtId);
