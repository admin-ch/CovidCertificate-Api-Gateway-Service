...
import static ch.admin.bag.covidcertificate.gateway.error.ErrorList.INVALID_OTP_LENGTH_CODE;
import static ch.admin.bag.covidcertificate.gateway.error.ErrorList.INVALID_OTP_LENGTH_MESSAGE;
...
class BearerTokenValidationServiceTest {
    ...
    void validate_tokenIsOK() throws NoSuchAlgorithmException, InvalidBearerTokenException {
        ...
        BearerTokenValidationService service = new BearerTokenValidationService();
    ...
    @Test
    void throwsException__ifInvalidLength() throws NoSuchAlgorithmException, InvalidBearerTokenException {
        //give
        CustomTokenProviderUtil customTokenProviderUtil = new CustomTokenProviderUtil(5000, privateKey, "test");
